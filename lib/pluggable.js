...
var Pluggable = module.exports = function () {
  this.stageCache = {};
  this.cache = {};
};
...
Pluggable.prototype.createPlugin = function (name, description, options, fn, app) {
 ...
 */
Pluggable.prototype.resolve = function (app, _plugins, options) {
  var self = this;
  options = options || {};
  _plugins = _plugins || [];
...
Pluggable.prototype.runStage = function (stage, app, params, done) {
  var self = this;
